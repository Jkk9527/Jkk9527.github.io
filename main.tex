...
\caption{
\textbf{Roadmap from audio black boxes to searchable podcast knowledge.}
...
The scale of podcasting shows why this problem matters. As Figure~\ref{fig:podcast-adoption} shows, Edison Research reported in \textit{The Podcast Consumer 2025} that 73\% of Americans aged 12 or older had ever consumed a podcast, 55\% had consumed one in the last month, and 40\% had consumed one in the last week \cite{Edison2025}. The same report estimated that total time spent with podcasts among Americans aged 13 or older had grown to 773 million hours per week \cite{Edison2025}. Globally, DataReportal reported that 22.1\% of online adults listened to at least one podcast each week in 2025 \cite{DataReportal2025}. These figures are not directly comparable because they measure different populations and behaviours, but together they show the scale of podcast use.
...
\section{Applications of AI Technologies: Three Steps from Audio to Searchable Knowledge}
...
\textbf{Misleading summary:} The guest supports carbon taxes.
\end{quote}
...
\subsection{Fairness and Visibility: Who Decides Whose Voices Are Heard?}
...
\section{Conclusion: Unlock Podcast Knowledge, Not Extract It}
